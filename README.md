...
- **Fine details smaller than ~7 mm get smoothed.** From the Poisson reconstruction at the default octree depth. Increase `POISSON_DEPTH` to preserve them, at the cost of more noise.
- **Don't move the object or table between scans.** The scanning protocol is designed for a fixed setup.
